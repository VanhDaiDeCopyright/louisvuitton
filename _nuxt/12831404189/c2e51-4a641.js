(window.LVWebpackJsonp = window.LVWebpackJsonp || []).push([
    [99, 108, 113, 141, 465], {
        ...
        1170: function(t, e, l) {
            ...
            var y = {
                    components: {
                        ...
                        ProductsSlider: () => Promise.all([l.e(0), l.e(4), l.e(466)]).then(l.bind(null, 1107))
                    },
                    props: {
                        data: {
                            type: Object,
                    ...
                    computed: {
                        mediaWidthLarge() {
                            if (this.forceEven) return "quarter";
                            if ("full-bleed" !== this.layoutType) return "third";
                            const {
                                length: t
                            } = this.skusData;
                            return t % 4 == 0 && t % 3 != 0 ? "quarter" : 2 === t ? "half" : "third"
                        },
                        rawSkus() {
                            return (this.data.skus || this.data.products || []).map((t => "object" == typeof t ? t.identifier : t))
                        },
                        rawKitID() {
                            return (this.data.skus || this.data.products || []).map((t => "object" == typeof t ? t.kitID : null))
                        },
                        customMedias() {
                            return (this.data.skus || this.data.products || []).reduce(((t, e) => (null != e && e.customMedia && (t[e.identifier] = e.customMedia), t)), {})
                        },
                        skusData() {
                            var t = this;
                            const e = this.rawSkus.reduce(((t, e, l) => {
                                const r = this.$store.state.products.skus[e];
                                return r && t.push({ ...r,
                                    ...this.customMedias[e] && {
                                        customMedia: this.customMedias[e]
                                    },
                                    ...this.rawKitID.some((t => !!t)) && {
                                        kitID: this.rawKitID[l]
                                    }
                                }), t
                            }), []).sort((function() {
                                let a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                    b = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {};
                                return t.rawSkus.indexOf(a.identifier) - t.rawSkus.indexOf(b.identifier)
                            }));
                            return this.forceEven ? e.slice(0, 2 * Math.floor(e.length / 2)) : e
                        }
                    },
                    ...
                    async mounted() {
                        await this.fetchSkus();
                        const t = this.$store.state.pageContext.lastShopTheSelectionItem;
                        t && Object(m.a)((() => {
                            const e = o()(this.$refs, "item_".concat(t, ".0"));
                            if (!e) return;
                            this.$lvSmoothScroll({
                                element: e.$el,
                                duration: 0,
                                offset: this.$lvStickyGetTotalHeight() + 16
                            });
                            const l = e.$el.querySelector("a");
                            l && l.focus({
                                preventScroll: !0
                            }), this.$store.commit(_.PAGE_CONTEXT_SET_LAST_SHOP_THE_SELECTION_ITEM, {})
                        }))()
                    },
                    created() {
                    ...
                    destroyed() {
                        this.decrementInstanceNumber()
                    },
                    methods: {
                        async fetchSkus() {
                            this.hasFetch || (await this.$store.dispatch(n.PRODUCTS_REFRESH_SKUS_ACTION, {
                                payload: this.rawSkus
                            }), this.hasFetch = !0)
                        },
                        handleSkuClicked(t, e) {
                            t && (this.$store.commit(_.PAGE_CONTEXT_SET_LAST_SHOP_THE_SELECTION_ITEM, "".concat(t, "_").concat(this.instance)), this.$lvTrackingSendEvent(this.$lvTrackingGenerateData({
                                actionGa: "product_selection",
                                actionId: "product_selection",
                                labelGa: t,
                                productSku: t,
                                actionPosition: "".concat(this.analyticValue, "_index_").concat(e + 1)
                            })))
                        },
                        getCtaTrackingData(t) {
                        ...
                        incrementInstanceNumber() {
                            f.instance += 1, this.instance = f.instance
                        },
                        decrementInstanceNumber() {
                            0 !== f.instance && (f.instance -= 1, this.instance = f.instance)
                        }
                    }
                },
                w = y,
                ...
                component = Object(k.a)(w, (function() {
                    var t = this,
                        e = t._self._c;
                    return t.skusData.length ? e("div", {
                        staticClass: "lv-shop-the-selection",
                        class: ["-layout-".concat(t.layoutType), {
                            "-dark": t.darkMode
                        }]
                    }, [t.data.title ? e("header", {
                        staticClass: "lv-shop-the-selection__header"
                    }, [e(t.markupTitle, {
                        tag: "component",
                        staticClass: "lv-shop-the-selection__title heading-m"
                        ...
                        staticClass: "lv-shop-the-selection__description body-m"
                    }) : t._e()], 1) : t._e(), t._v(" "), t.isSlider ? e("ProductsSlider", t._b({
                        staticClass: "lv-shop-the-selection__slider",
                        attrs: {
                            id: t.sliderId,
                            "slides-per-view": t.slidesPerViewMobile,
                            "slides-per-view-desktop": t.slidesPerViewDesktop,
                            "centered-slides": t.centeredSlides,
                            "has-mobile-dots": !0,
                            skus: t.skusData,
                            fullwidth: !0,
                            "has-wishlist": t.hasWishlist,
                        ...
                        on: {
                            "sku-clicked": e => {
                                ...
                                return t.handleSkuClicked((l || {}).identifier, r)
                            }
                        }
                    }, "ProductsSlider", t.$attrs, !1)) : e("ul", {
                        staticClass: "lv-shop-the-selection__grid lv-list"
                    }, t._l(t.skusData, (function(l, r) {
                        return e("li", {
                            key: r,
                            staticClass: "lv-shop-the-selection__product-card",
                            class: "-".concat(t.mediaWidthLarge)
                        }, [e("ProductCard", {
                            ref: "item_".concat(l.identifier, "_").concat(t.instance),
                            refInFor: !0,
                            class: {
                                "-custom-media": l.customMedia
                            },
                            attrs: {
                                sku: l,
                                "has-wishlist": t.hasWishlist && !l.customMedia,
                                "media-widths": {
                                    xs: "half",
                                    m: t.mediaWidthLarge
                                },
                                "layout-type": t.layoutType,
                                "is-static": !1,
                                "has-otherviews": t.hasOtherviews,
                                "is-media-portrait": t.isMediaPortrait,
                                "is-critical": t.isCritical,
                                "is-floor-allowed": t.isFloorAllowed,
                                "tracking-values": {
                                    actionPosition: "".concat(t.analyticValue, "_index_").concat(r + 1),
                                    labelGa: l.identifier
                                },
                                "url-params": {
                                    kitID: l.kitID
                                }
                            ...
                            scopedSlots: t._u([l.customMedia ? {
                                key: "media",
                                fn: function() {
                    ...
                    })), 0), t._v(" "), t.data.ctaList && t.data.ctaList.length > 0 ? e("div", {
                        staticClass: "lv-shop-the-selection__cta-wrapper"
                    }, t._l(t.data.ctaList, (function(l, r) {
                        return e("SmartLink", {
                            directives: [{
                                name: "tracking",
                                rawName: "v-tracking",
                                value: t.getCtaTrackingData(l.name),
                                expression: "getCtaTrackingData(cta.name)"
                            }],
                            key: "".concat(l.identifier, "_").concat(r),
                            staticClass: "lv-shop-the-selection__cta lv-button",
                            class: t.ctaClass,
                            attrs: {
                                url: l.url,
                                type: l.identifier,
        ...
        1203: function(t, e, l) {
            ...
            (0, l(10).default)("6620a1e3", content, !0, {
                sourceMap: !1
            })
        },
        1306: function(t, e, l) {
            ...
            var r = l(974),
                ...
                m = {
                    components: {
                        EditorialPush: r.default,
                        EditorialTextBlock: o.default,
                        ContentPushList: d.default,
                        EditorialMedia: n.default,
                        ShopTheSelection: c.default,
                        SmartLink: h.default
                    },
                    props: {
                        data: {
                    ...
                    computed: {
                        ...
                        isSliderDisplayed() {
                            return this.hasSlider.desktop && !this.isSmall || this.hasSlider.mobile && this.isSmall
                        },
                        canAnimateMedia() {
                            return !this.isHero && this.hasMedia && this.hasGrid && this.isSmall && this.$store.state.isMediaQueryInit
                        },
                        hasMedia() {
                            return !(!this.data.image && !this.data.video)
                        },
                        hasGrid() {
                            var t, e;
                            return !!(null !== (t = this.data.skus) && void 0 !== t && t.length || null !== (e = this.data.items) && void 0 !== e && e.length)
                        },
                        mediaCta() {
                            return (this.data.ctaList || [])[0] || {}
                        },
                        hasCtas() {
                            return (this.data.ctaList || []).length > 0 && !this.isHero
                        }
                    },
                    watch: {
                        canAnimateMedia: {
                            handler(t) {
                                t ? this.setupReziseListener() : this.removeReziseListener()
                            }
                        }
                    },
                    beforeDestroy() {
                        this.removeReziseListener()
                    },
                    methods: {
                        setupReziseListener() {
                            this.onResizeListener || (this.onResizeListener = Object(_.a)((() => this.onResize())), window.addEventListener("resize", this.onResizeListener), this.$nextTick((() => this.onResizeListener())), this.observer = new MutationObserver((() => this.onResizeListener())), this.observer.observe(this.$refs.grid, {
                                childList: !0
                            }))
                        },
                        removeReziseListener() {
                            this.observer && this.observer.disconnect(), window.removeEventListener("resize", this.onResizeListener)
                        },
                        concatenateAnalyticValue(t) {
                            return this.analyticValue ? "".concat(t, "_").concat(this.analyticValue) : t
                        },
                        animate(t) {
                            const e = this.$el;
                            e && this.$lvObserveScrollAnimate({
                                el: e,
                                ratio: t,
                                animations: [{
                                    variable: "scale",
                        ...
                        onResize() {
                            var t;
                            const e = this.$refs.grid;
                            if (!e) return;
                            const l = null === (t = this.$refs.media) || void 0 === t ? void 0 : t.$el,
                                r = l && l.getBoundingClientRect().height,
                                o = parseInt(window.getComputedStyle(this.$el).getPropertyValue("gap"), 10) || 0,
                                d = Array.from(e.children).reduce(((t, e) => t + e.getBoundingClientRect().height), 0);
                            if (this.hasEmptyGrid = !d, !r || !d) return;
                            const n = r > d ? r - d - o : 0,
                                c = this.$el.nextElementSibling;
                            c && (c.style.marginTop = n > 0 ? "".concat(-1 * n, "px") : null)
                        }
                    }
                },
                f = (l(2130), l(0)),
                component = Object(f.a)(m, (function() {
                    ...
                    return e("section", {
                        directives: [{
                            name: "observe-scroll",
                            rawName: "v-observe-scroll",
                            value: {
                                startAt: 1,
                                callback: e => t.canAnimateMedia && t.animate(e)
                            },
                            expression: "{ startAt: 1, callback: ratio => canAnimateMedia && animate(ratio) }"
                        }],
                        staticClass: "lv-editorial-hub",
                        class: {
                            "-hero": t.isHero, "-animate": t.canAnimateMedia, "-compact": t.isHero && !t.hasGrid, "-has-ctas": t.hasCtas
                        }
                    }, [t.isHero ? e("EditorialPush", t._g({
                        attrs: {
                            "is-hero": "",
                            data: { ...t.data,
                                items: []
                            ...
                            "text-align": "center",
                            wide: "",
                            "title-class-mobile": "heading-l",
                            "title-class-desktop": "heading-l",
                            "markup-title": "h2",
                            "fullscreen-mobile": "",
                            "is-critical": ""
                        }
                    }, t.$listeners)) : [t.hasMedia ? e("div", {
                        staticClass: "lv-editorial-hub__media"
                    }, [t.mediaCta.url ? e("SmartLink", {
                        attrs: {
                            url: t.mediaCta.url,
                            type: t.mediaCta.type || t.mediaCta.identifier,
                            "not-crawlable": "",
                            "no-focus": ""
                        },
                        nativeOn: {
                            click: function(e) {
                                return t.$emit("link-clicked", t.mediaCta)
                            }
                        }
                    }, [e("EditorialMedia", {
                        ref: "media",
                        ...
                        ref: "grid",
                        staticClass: "lv-editorial-hub__grid",
                        class: {
                            "-slider": t.isSliderDisplayed, "-gutters-small": t.smallGridGutters, "-is-empty": t.hasEmptyGrid
                        }
                    }, [t.isHero ? t._e() : e("EditorialTextBlock", t._g({
                        attrs: {
                            data: { ...t.data,
                                ctaList: []
                            },
                            ...
                            wide: !0,
                            "markup-title": "h2",
                            "title-class-mobile": "heading-m",
                            "title-class-desktop": "heading-l",
                            "text-class-mobile": "-text-is-grey"
                        }
                    }, t.$listeners)), t._v(" "), (t.data.skus || []).length ? e("ShopTheSelection", {
                        staticClass: "lv-editorial-hub__shop",
                        attrs: {
                            data: {
                                skus: t.data.skus
                            },
                            "force-even": t.forceEven,
                            "is-media-portrait": !0,
                            "is-critical": t.isHero,
                            "analytic-value": t.concatenateAnalyticValue("product_card_push"),
                            "layout-type": "compact"
                        }
                    }) : (t.data.items || []).length ? e("ContentPushList", {
                        staticClass: "lv-editorial-hub__items",
                        attrs: {
                            data: t.data.items,
                            "force-even": t.forceEven,
                            "center-text": t.centerText,
                            "has-slider": t.hasSlider,
                            "is-critical": t.isHero,
                            "analytic-value": t.concatenateAnalyticValue(t.data.isService ? "service_push" : "grid_gallery_push")
                        }
                    }) : t._e(), t._v(" "), t.hasCtas ? e("EditorialTextBlock", t._g({
                        ref: "ctas",
                        attrs: {
                            "button-class": t.buttonClass,
                            "button-fullwidth": t.buttonFullwidth,
                            data: {
                                ctaList: t.data.ctaList
                            },
                            "center-text": !0
                        }
                    }, t.$listeners)) : t._e()], 1)], 2)
                }), [], !1, null, null, null);
            e.default = component.exports
        },
        1380: function(t, e, l) {
        ...
        1610: function(t, e, l) {
            ...
            (0, l(10).default)("cdbbfe56", content, !0, {
                sourceMap: !1
            })
        },
        2130: function(t, e, l) {
        ...
        929: function(t, e, l) {
            ...
            (0, l(10).default)("51ae5d06", content, !0, {
                sourceMap: !1
            })
        },
        931: function(t, e, l) {
            "use strict";
            l.r(e), l.d(e, "DELAY", (function() {
                return v
            }));
            l(3), l(56);
            var r = l(5),
            ...
            const v = 1e3,
                _ = [],
                m = ["swf", "avi", "flv", "mpg", "rm", "mov", "wav", "asf", "3gp", "mkv", "rmvb", "mp4"],
                f = () => {
                    _.length && (_[0].video.play(), _[0].started = 1, window.setTimeout((() => {
                        _.splice(0, 1), _.length > 0 && f()
                    }), v))
                };
            var y = {
                    components: {
                    ...
                    watch: {
                        ...
                        isPlaying(t) {
                            const e = _.findIndex((q => q.video === this.$refs.video));
                            var video;
                            t && -1 === e ? (video = this.$refs.video).currentTime > 0 ? video.play() : (_.push({
                                video: video,
                                started: 0
                            }), 1 === _.length ? window.requestAnimationFrame(f) : _.sort(((a, b) => a.started !== b.started ? b.started - a.started : 2 & a.video.compareDocumentPosition(b.video) ? 1 : -1))) : t || (e > -1 && _.splice(e, 1), this.$refs.video.pause())
                        },
                        currentVideoSrc(t, e) {
                            var l;
                            e && t !== e && (this.isVideoLoaded = !1, null === (l = this.$refs.video) || void 0 === l || l.addEventListener("loadedmetadata", this.setIsVideoLoaded))
                        }
                    },
                    mounted() {
                    ...
                    methods: {
                        ...
                        setIsVideoLoaded() {
                            this.isVideoLoaded = !0, this.resizeListener = Object(o.a)(this.onResize), this.resizeListener(), window.addEventListener("resize", this.resizeListener), this.$refs.video.removeEventListener("loadedmetadata", this.setIsVideoLoaded), this.isFreecasterVideo || this.$emit("loaded", this.$refs.video)
                        },
                        onResize() {
                            this.getVideoSrc()
                        },
        ...
        964: function(t, e, l) {
            ...
            (0, l(10).default)("255b496d", content, !0, {
                sourceMap: !1
            })
        },
        974: function(t, e, l) {
            ...
            var r = l(940),
                ...
                d = {
                    components: {
                        EditorialMedia: r.default,
                        EditorialTextBlock: o.default,
                        Slider: () => l.e(0).then(l.bind(null, 909))
                    },
                    inheritAttrs: !1,
                    props: {
                        data: {
                        ...
                        id: {
                            type: String,
                            default: "lv-editorial-push-slider"
                        },
                        mediaWidths: {
                            type: Object,
                            default: () => ({
                    ...
                    computed: {
                        hasFullscreenGradient() {
                            return "center" === this.verticalTextAlign && !this.contrast
                        },
                        isSticky() {
                            return this.sticky && "center" !== this.textAlign
                        },
                        hasSlider() {
                ...
                component = Object(n.a)(d, (function() {
                    var t = this,
                        e = t._self._c;
                    return e("div", {
                        staticClass: "lv-editorial-push",
                        class: [{
                            "-reverse": !0 === t.reverse,
                            "-reverse-mobile": "mobile" === t.reverse,
                            "-reverse-desktop": "desktop" === t.reverse || "right" === t.textAlign,
                            "-fullscreen-mobile": t.fullscreenMobile,
                            "-horizontal-center": "center" === t.textAlign,
                            "-vertical-center": "center" === t.verticalTextAlign,
                            "-sticky": t.isSticky,
                            "-contrast": t.contrast,
                            "-has-slider": t.hasSlider
                        }]
                    }, [e("div", {
                        staticClass: "lv-editorial-push__wrapper"
                    }, [e("div", {
                        staticClass: "lv-editorial-push__media-wrap"
                    }, [t.hasSlider ? e("Slider", t._g({
                        attrs: {
                            id: t.id,
                            items: t.data.items,
                            "has-mobile-dots": !0,
                            "dots-outside": t.dotsOutside,
                        ...
                        scopedSlots: t._u([{
                            ...
                            fn: function(l) {
                                ...
                                return [e("EditorialMedia", t._g(t._b({
                                    staticClass: "lv-editorial-push__media",
                                    attrs: {
                                        data: { ...t.defaultRatios,
                                            ...r
                                        },
                                        widths: t.mediaWidths,
                                        load: o && d,
                                        "player-options": t.videoPlayerOptions,
                                        contrast: t.contrast,
                                        gradient: !t.hasFullscreenGradient || "full"
                                    }
                                }, "EditorialMedia", { ...r.props,
                                    ...t.$attrs
                                }, !1), t.$listeners))]
                            }
                        }], null, !1, 2863485028)
                    }, t.$listeners)) : e("EditorialMedia", t._g(t._b({
                        staticClass: "lv-editorial-push__media",
                        attrs: {
                            data: { ...t.defaultRatios,
                                ...t.data
                    ...
                    }, "EditorialMedia", { ...t.data.props,
                        ...t.$attrs
                    }, !1), t.$listeners))], 1), t._v(" "), e("div", {
                        staticClass: "lv-editorial-push__details",
                        class: [t.textAlign ? "-".concat(t.textAlign) : ""]
                    }, [e("EditorialTextBlock", t._g(t._b({
                        attrs: {
                            data: { ...t.data,
                                ...t.data.link && {
                                    cta: t.data.link
                            ...
                            "center-text": "center" === t.textAlign
                        }
                    }, "EditorialTextBlock", t.$attrs, !1), t.$listeners)), t._v(" "), t._t("additionalContentBefore")], 2)]), t._v(" "), t._t("additionalContentAfter")], 2)
                }), [], !1, null, null, null);
            e.default = component.exports
        }
    }
]);
//# sourceMappingURL=_nuxt/12831404189/c2e51-4a641.js.map